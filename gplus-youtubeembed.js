...
function optimizeYouTubeEmbeds() {
    ...
    for ( var i = 0; i < frames.length; i++ ) {
        frames[i].contentWindow.document.close();
        ...
        //     var code='<div style="position:relative; width: '+w+'px; height: '+h+'; overflow: hidden;margin:0 auto"><a href="#"  onclick="LoadYoutubeVidOnPreviewClick(\''+id+'\','+w+','+h+');return false;" id="skipser-youtubevid-'+id+'"><div class="playbutton"><img src="http://img.youtube.com/vi/'+id+'/0.jpg" class="thumbnail"/></div></a></div>';
        //     //<div style="background-image: url("workspace/iconfinder_play_alt_118620.png");height: 77px;width: 77px; position:relative; margin-left:'+pw+'px; margin-top:-'+ph+'px;z-index:5;"></div>
