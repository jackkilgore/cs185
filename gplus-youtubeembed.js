...
function optimizeYouTubeEmbeds() {
    ...
    for ( var i = 0; i < frames.length; i++ ) {
        ...
        if ( frames[ i ].src && frames[ i ].src.length > 0 && frames[ i ].src.match(/http(s)?:\/\/www\.youtube\.com/)) {
            ...
            var code='<div style="position:relative; width: '+w+'px; height: '+h+'; overflow: hidden;margin:0 auto"><a href="#"  onclick="LoadYoutubeVidOnPreviewClick(\''+id+'\','+w+','+h+');return false;" id="skipser-youtubevid-'+id+'"><img src="http://img.youtube.com/vi/'+id+'/0.jpg" style="width:100%; height:100%; margin: -9.5% 0px -12%;" /><div style="background-image: url("workspace/iconfinder_play_alt_118620.png");height: 77px;width: 77px; position:relative; margin-left:'+pw+'px; margin-top:-'+ph+'px;z-index:5;"></div></a></div>';
            // var code='<a href="#"  onclick="LoadYoutubeVidOnPreviewClick(\''+id+'\','+w+','+h+');return false;" id="skipser-youtubevid-'+id+'"><img src="http://i.ytimg.com/vi/'+id+'/0.jpg" style="width:'+w+'px; height:'+h+'px;" /></a>'
            // var code = '<div style="position:relative; width: '+w+'px; height: '+h+'; overflow: hidden;"><img src="http://img.youtube.com/vi/'+id+'/0.jpg" style="width:100%; height:100%; margin: -9.5% 0px -12%;" /></div>'
...
function LoadYoutubeVidOnPreviewClick(id,w ,h) {
    var code='<iframe src="https://www.youtube.com/embed/'+id+'/?&mute=0&showinfo=0&rel=0&autoplay=1&loop=0&control=0" width="'+w+'" height="'+h+'" frameborder=0 allowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" style="border:1px solid #ccc;" ></iframe>';
...
//             var code='<div style="width:'+w+'px; height:'+h+'px; margin:0 auto"><a href="#"  onclick="LoadYoutubeVidOnPreviewClick(\''+id+'\','+w+','+h+');return false;" id="skipser-youtubevid-'+id+'"><img src="http://i.ytimg.com/vi/'+id+'/0.jpg" style="width:'+w+'px; height:'+h+'px;" />'+
