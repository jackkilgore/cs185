...
function LoadYoutubeVidOnPreviewClick(id,w ,h) {
    var code='<iframe src="https://www.youtube.com/embed/'+id+'/?&mute=0&showinfo=0&rel=0&autoplay=1&loop=0&control=0" width="'+w+'" height="'+h+'" frameborder=0 allowfullscreen allow="autoplay" style="border:1px solid #ccc;" ></iframe>';
