...
function TextBody() {
    ...
    return (
      <div style={{paddingLeft: "10px"}}>
		...
		<input type="text" id="fname1" name="fname1" /><br/><br/>
		How do you think? <br/>
		<input checked="checked" type="radio" name="radio_test" id="rd1" value="1" />
		<label htmlFor="rd1">an inner voice</label><br />
		<input type="radio" name="radio_test" id="rd2" value="2" />
		<label htmlFor="rd2">a mush of senses</label><br />
		<input type="radio" name="radio_test" id="rd3" value="3" />
		<label htmlFor="rd3">a bit of both</label><br />
